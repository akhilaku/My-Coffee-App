...
public class MainActivity extends AppCompatActivity {
    ...
    public MainActivity(Object address) {
        Address = address;
    }
     ...
     * @return text summary
     */
    private String createOrderSummary(String name,int price, boolean addWhippedCream, boolean addChocolate, String Address){
        String priceMessage = "Name:  " + name;
        priceMessage +=  "\n" + getString(R.string.WhippedCream)+ "  :  " + addWhippedCream;
        priceMessage += "\n" + getString(R.string.Chocolate)+ "  :  " + addChocolate;
        priceMessage += "\n"+ getString(R.string.Quantity)+ "  :  " + quantity;
        priceMessage += "\n"+ getString(R.string.Total)+ "  :  " + price +  " INR";
    ...
    public void submitOrder(View view) {
        ...
        String priceMessage = createOrderSummary(name, price, hasWhippedCream, hasChocolate, (String) Address);
        /**
         *  start an Email Intent here so when the user place an order it uses our email app
         * */
        Intent intent = new Intent(Intent.ACTION_SENDTO);
        intent.setData(Uri.parse("mailto:mycoffee4me@gmail.com")); // only email apps should handle this
        intent.putExtra(Intent.EXTRA_SUBJECT, "Just Have an Order for " + name);
